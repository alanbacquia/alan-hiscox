...
const ContentIntro = ({ heading, body, ctaLabel, ctaUrl, className }) => {
  return (
    <section
      className={cn(
        'w-full bg-white px-5 pt-20 pb-10 md:px-20 md:pt-40 md:pb-20',
        className,
      )}
    >
      <div className="mx-auto flex w-full max-w-[1360px] flex-col gap-10 md:flex-row md:gap-10">
        <div className="flex min-w-0 flex-1 flex-col">
          {heading && (
            <h1 className="font-heading text-3xl leading-[1.08] font-semibold text-balance text-hiscox-heading md:text-5xl">
              {heading}
            </h1>
          )}
        </div>
